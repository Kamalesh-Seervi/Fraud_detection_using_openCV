...
from create_dataset import start_capture, register_user
...
class PageThree(tk.Frame):
    ...
    def capimg(self):
        ...
        register_user(self.controller.active_name,[])
    ...
    def trainmodel(self):
        ...
        myquery = { "name": self.controller.active_name }
        newvalues = { "$set": { "trained": True} }
